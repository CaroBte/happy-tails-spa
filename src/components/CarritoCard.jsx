...
const CarritoCard = ({ img, nombre, precio, cantidad, id, subtotalOrden, suma, resta, eliminarOrden }) => {
    ...
    return (
        <>
            <div className="cart-card py-2 mb-3 mx-2 mx-sm-5 mx-md-2 d-flex align-items-center">
                ...
                <div className="cart-info ms-2">
                    ...
                    <div className='d-flex align-items-center justify-content-between subt rounded-2'>
                        <div className="input-group mas-menos m-0 ">
                            <button className="btn btn-sm m-0" onClick={() => suma(id)}>+</button>
                            <input disabled type="text text-center" className="" value={cantidad} />
                            <button className="btn btn-sm m-0" onClick={() => resta(id)}>-</button>
                        </div>
                        <p className='m-0 px-2 subtotal rounded-2'>Subtotal: ${subtotalOrden}</p>
                    </div>
