...
const Footer = () => {
    return (
        <>
            <div className="cont_footer d-flex">
                ...
                <div className="powered">
                    <h5>Powered with <i class="fa-solid fa-heart"></i> by <a href="https://github.com/Bney28"> Bney,</a> <a href="https://github.com/CaroBte/"> CaroBte,</a> <a href="https://github.com/Jaredzu"> Jaredzu</a></h5>
                </div>
